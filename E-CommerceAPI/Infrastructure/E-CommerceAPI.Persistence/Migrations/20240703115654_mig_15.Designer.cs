...
namespace E_CommerceAPI.Persistence.Migrations
{
    ...
    [Migration("20240703115654_mig_15")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_CommerceAPI.Domain.Entities.Endpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("E_CommerceAPI.Domain.Entities.Menu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AppRoleEndpoint", b =>
                {
                    b.HasOne("E_CommerceAPI.Domain.Entities.Endpoint", null)
                        .WithMany()
            ...
            modelBuilder.Entity("E_CommerceAPI.Domain.Entities.Endpoint", b =>
                {
                    b.HasOne("E_CommerceAPI.Domain.Entities.Menu", "Menu")
                        .WithMany("Endpoints")
